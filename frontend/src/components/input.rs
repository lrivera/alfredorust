...
const INPUT_BASE: &str = "w-full rounded-md border border-input bg-background text-foreground \
     placeholder:text-muted-foreground px-3 py-2 text-sm outline-none transition-colors \
